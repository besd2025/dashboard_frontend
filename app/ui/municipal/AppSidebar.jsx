...
const navItems = [
  ...
  //   name: "Dashboard",
  //   path: "/municipal/home",
  //   // subItems: [{ name: "Home", path: "/municipal/home", pro: false }],
  // },
  ...
  //   subItems: [
  //     { name: "Details", path: "/municipal/cultivators" },
  //     {
  //       name: "Liste",
  //       path: "/municipal/cultivators/list",
  //     },
  //   ],
  //   subPath: ["/municipal/cultivators/profile"],
  // },
  // {
  //   icon: <BoxCubeIcon />,
  //   name: "Stock",
  //   path: "/municipal/stocks",
  //   subItems: [
  //     { name: "Details", path: "/municipal/stocks" },
  //     { name: "Achats", path: "/municipal/stocks/achats" },
  //     {
  //       name: "Sorties",
  //       path: "/municipal/stocks/sold_out",
  //     },
  //   ],
  // },
  {
