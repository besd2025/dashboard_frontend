...
import EditUserProfile from "../cultivators/profile/edit_user_profile";
import FilterHangarList from "../hangars/filter_hangar_list";
...
import Search_Form from "../../ui_elements/form/search_form";
import Link from "next/link";
import EnqueteHangarDetails, { HangarDetails } from "./details";
    ...
    try {
     ...
     console.log(response)
      ...
      const formattedData = allData.map((item) => ({
        ...
        "Quantite_totale_Stock": item?.quantity_remaining_kg || "",
        ...
        "observation_generale": item.observations || "",
