...
export default function CardsOverview({ hangar_id }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-16 md:gap-4">
      ...
      <div className="rounded-2xl col-span-6 lg:col-span-5 flex flex-row justify-between border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-4">
        <div>
          <div className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800">
            {/* <GroupIcon className="text-gray-800 size-6 dark:text-white/90" /> */}
            <svg
      ...
      <div className="rounded-2xl col-span-6 lg:col-span-3 border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-4">
      ...
      <div className="rounded-2xl col-span-6 lg:col-span-2 border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-4">
        <div className="flex items-end justify-between mb-2">
          <div>
            <span className="text-sm text-gray-500 dark:text-gray-400">
              Cultivateurs
