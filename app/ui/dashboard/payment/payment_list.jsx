          ...
          <Table>
            ...
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]  shadow-theme-xs ">
              <TableRow>
                ...
                <TableCell
                  isHeader
                  className="px-5 py-3 font-semibold  text-start text-theme-xs dark:text-gray-400 uppercase sticky right-0 bg-amber-400 text-white rounded-tr-lg rounded-br-lg"
                >
                  Status
                </TableCell>
              </TableRow>
            ...
            >
              {data.map((order) => (
                <TableRow key={order.id} className={"group"}>
                  ...
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400"></TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400"></TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400 sticky right-0 bg-white dark:bg-dark-900/50">
                    <Badge color="success" className="w-max">
                      payé
                    </Badge>
                    <Badge color="error" className="w-max">
                      non payé
                    </Badge>
                  </TableCell>
                </TableRow>
