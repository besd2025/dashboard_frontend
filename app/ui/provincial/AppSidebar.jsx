...
const navItems = [
  ...
  // },
  {
    ...
    subPath: [
      ...
      "/provincial/hangars/details/achats",
    ],
  },
  // {
  //   icon: <SettingsIcon />,
  //   name: "Parametre",
  //   path: "/provincial/settings/profile",
  //   subPath: [
  //     "/provincial/settings/security",
  //     "/provincial/settings/manage",
  //     "/provincial/settings/preferences",
  //     "/provincial/settings/synchronisation",
  //     "/provincial/settings/security/change_password",
  //     "/provincial/settings/roles_manager",
  //   ],
  // },
];
