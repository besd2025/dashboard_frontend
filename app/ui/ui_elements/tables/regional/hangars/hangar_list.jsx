...
import FilterUserProfile from "../../../../regional/cultivators/profile/filter_user_profile";
import FilterHangarList from "../../../../regional/hangars/filter_hangar_list";
...
function AllCultivatorsList() {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03]  sm:px-6 sm:pt-6 ">
      ...
      <div
        className={`${
          isApplicationMenuOpen ? "flex justify-center" : "hidden"
