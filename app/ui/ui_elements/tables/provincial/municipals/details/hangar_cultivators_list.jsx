...
import EditHangarCultiv from "../../../../../provincial/municipals/details/edit_hangar_cultiv";
...
function HangarCultivatorsList({ hangar_id }) {
  ...
  useEffect(() => {
    async function getData() {
      try {
        const results = await fetchData("get", "municipals/", {
          params: {},
          additionalHeaders: {},
          body: {},
        });
                    ...
                    <div className="relative inline-block">
                      ...
                      >
                        <DropdownItem
                          ...
                          tag="a"
                          href={"/municipal/cultivators/profile"}
