...
import EditHangarCultiv from "../../../../../municipal/municipals/details/edit_hangar_cultiv";
import EditHangarAchats from "../../../../../municipal/municipals/details/edit_hangar_achats";
...
function HangarAchatList() {
  ...
  useEffect(() => {
    async function getData() {
      try {
        const results = await fetchData("get", "municipals/cinq_recents/", {
          params: {},
          additionalHeaders: {},
          body: {},
        });
