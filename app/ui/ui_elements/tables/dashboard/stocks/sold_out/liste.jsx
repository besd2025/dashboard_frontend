...
import ModificationAchat from "../../../../../dashboard/stocks/sold_out/modifications/achat";
...
function ListeVente() {
  ...
  const {
    isOpen: isOpenHistorique,
    openModal: openModalHistorique,
    closeModal: closeModalHistorique,
  } = useModal();
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03]  sm:px-6 sm:pt-6 ">
                        ...
                        <DropdownMenuContent className="w-40" align="start">
                          ...
                          <DropdownMenuGroup>
                            ...
                            {user?.session?.category == " Admin" && (
                              <DropdownMenuItem
                                onSelect={() => supprimerVente(order?.id)}
                              >
                                Supprimer
                              </DropdownMenuItem>
                            )}
      ...
      <Modal
        isOpen={isOpenHistorique}
        onClose={closeModalHistorique}
        className="max-w-[700px] m-4 px-6 pt-14 pb-4"
      >
