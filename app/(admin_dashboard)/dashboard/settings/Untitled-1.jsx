  ...
  return (
    <div
      className={`min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased ${
        isDark ? "dark bg-gray-700 text-white" : "bg-white text-black"
      }`}
    >
      {/* Header */}
      <div className="fixed w-full flex items-center justify-between h-14 text-white z-10">
        ...
        <div className="flex justify-between items-center h-14 bg-blue-800 dark:bg-gray-800 w-[calc(100%-3.5rem)] md:w-[calc(100%-16rem)]">
