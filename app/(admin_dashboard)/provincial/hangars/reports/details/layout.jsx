          ...
          <div className="w-full">
            <div className="block">
              <div className="overflow-x-auto scrollbar-hide">
                ...
                >
                  <Link
                    href={`/provincial/hangars/reports/details/cultivators-achats?hangar_id=${hangarId}`}
                  ...
                  <Link
                    href={`/provincial/hangars/reports/details/ventes?hangar_id=${hangarId}`}
                  ...
                  <Link
                    href={`/provincial/hangars/reports/details/transfers?hangar_id=${hangarId}`}
